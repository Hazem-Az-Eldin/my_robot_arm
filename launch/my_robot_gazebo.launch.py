...
def generate_launch_description():
    ...
    xacro_file = get_package_share_directory('my_robot_arm') + '/description' + '/xacro/' + robot_model + '.urdf.xacro'
    ...
    spawn_entity_robot = Node(package='gazebo_ros',
                              ...
                              arguments=['-entity', 'my_robot_arm', '-topic', 'robot_description'],
                              output='screen')

    # Start Gazebo with my empty world
    world_file_name = 'my_empty_world.world'
    world = os.path.join(get_package_share_directory('my_robot_arm'), 'worlds', world_file_name)
